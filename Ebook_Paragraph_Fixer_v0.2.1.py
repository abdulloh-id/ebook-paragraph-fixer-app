...
oyna['background'] = '#121212'

txt = Text(oyna, width=45, height=11, font='Calibri 10', bg='#121212', fg='white',  wrap=WORD)
txt.focus()
txt.grid(row=0, column=0, padx=(5,0), pady=(5,0))

rslt = Text(oyna, width=45, height=11, font=('Calibri 10'), bg='#121212', fg='white', wrap=WORD)
...
clr = Button(oyna, text="Clear", width=6, height=2, bg='#00000C', fg='orange', command=clear_entry)
clr.grid(row=0, column=2, sticky="new", padx=(2,5), pady=5)

cpy = Button(oyna, text="Copy", width=6, height=2, bg='#00000C', fg='orange', command=lambda:[copy_to_clipboard(), clear_entry()])

...
txt = Text(root, width=45, height=11, font='Calibri 10', bg='#121212', fg='white',  wrap=WORD)
txt.focus()
txt.grid(row=0, column=0, padx=(5,0), pady=(5,0))

rslt = Text(root, width=45, height=11, font=('Calibri 10'), bg='#121212', fg='white', wrap=WORD)
...
txt.config(yscrollcommand=scrl.set) ##FF8C00
...
def info_popup(event=None):
    ...
    Label(top, justify = "left", text="\nInfo:\
     \n✅ This program can be used for correcting unintended new lines in epub html documents, especially the e-books from www.fadedpage.com.\n\
